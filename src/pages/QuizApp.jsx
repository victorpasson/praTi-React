...
// Services
import { handleAnswer, questions } from '../services/Questions';
      ...
      {currentQuestion < questions.length ? ( // Verifica se ainda há perguntas para responder.
        <div>
          ...
          {questions[currentQuestion].options.map((option) => (
            <OptionButton key={option} onClick={() => handleAnswer(option, setScore, score, setCurrentQuestion, currentQuestion)}>{option}</OptionButton> /* Renderiza os botões de opções de resposta */
          ))}
        </div>
      ) : (
